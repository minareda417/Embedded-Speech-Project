...
//
//#include <stdint.h>
//#include <avr/pgmspace.h>/* for c modules */
//
...
//#else
//void fft_input (const int8_t *, complex_t *);
//#endif
//#endif
...
int8_t fmuls_f (int8_t, int8_t);

extern const int8_t tbl_window[] PROGMEM;
...
.macro dc_b_scaled v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16
    .dc.b ((\v1)>>8), ((\v2)>>8), ((\v3)>>8), ((\v4)>>8), ((\v5)>>8), ((\v6)>>8), ((\v7)>>8), ((\v8)>>8), ((\v9)>>8), ((\v10)>>8), ((\v11)>>8), ((\v12)>>8), ((\v13)>>8), ((\v14)>>8), ((\v15)>>8), ((\v16)>>8)
.endm

.macro	SQRT16	; 16bit square root (T2H:T2L -> BL)
	clr	BL
	clr	CL
	ldi	DH, 8
90:	lsl	T2L
